import{d1 as _,d4 as U,dw as l,d5 as I,d6 as O,dj as S,cX as u,db as w,cW as F,d7 as c,dR as A,cQ as $,dS as D,dh as N,dT as W,dv as y,cP as d,dc as E,cV as x,dU as j,cO as p,dV as k,cR as b,dW as M,dN as R,du as P}from"./index-BB0weW2m.js";const z=_`
  :host {
...
`;var v=function(t,e,i,r){var s=arguments.length,o=s<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,i):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(t,e,i,r);else for(var a=t.length-1;a>=0;a--)(n=t[a])&&(o=(s<3?n(o):s>3?n(e,i,o):n(e,i))||o);return s>3&&o&&Object.defineProperty(e,i,o),o};let m=class extends O{constructor(){super(),this.unsubscribe=[],this.tabIdx=void 0,this.connectors=S.state.connectors,this.authConnector=this.connectors.find(e=>e.type==="AUTH"),this.remoteFeatures=u.state.remoteFeatures,this.isPwaLoading=!1,this.unsubscribe.push(S.subscribeKey("connectors",e=>{this.connectors=e,this.authConnector=this.connectors.find(i=>i.type==="AUTH")}),u.subscribeKey("remoteFeatures",e=>this.remoteFeatures=e))}connectedCallback(){super.connectedCallback(),this.handlePwaFrameLoad()}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){let e=this.remoteFeatures?.socials||[];const i=!!this.authConnector,r=e?.length,s=w.state.view==="ConnectSocials";return(!i||!r)&&!s?null:(s&&!r&&(e=F.DEFAULT_SOCIALS),c` <wui-flex flexDirection="column" gap="2">
      ${e.map(o=>c`<wui-list-social
          ...
          ></wui-list-social>`)}
    </wui-flex>`)}async onSocialClick(e){e&&await A(e)}async handlePwaFrameLoad(){if($.isPWA()){this.isPwaLoading=!0;try{this.authConnector?.provider instanceof D&&await this.authConnector.provider.init()}catch(e){N.open({displayMessage:"Error loading embedded wallet in PWA",debugMessage:e.message},"error")}finally{this.isPwaLoading=!1}}}};m.styles=z;v([U()],m.prototype,"tabIdx",void 0);v([l()],m.prototype,"connectors",void 0);v([l()],m.prototype,"authConnector",void 0);v([l()],m.prototype,"remoteFeatures",void 0);v([l()],m.prototype,"isPwaLoading",void 0);m=v([I("w3m-social-login-list")],m);const V=_`
  wui-flex {
...
`;var T=function(t,e,i,r){var s=arguments.length,o=s<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,i):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(t,e,i,r);else for(var a=t.length-1;a>=0;a--)(n=t[a])&&(o=(s<3?n(o):s>3?n(e,i,o):n(e,i))||o);return s>3&&o&&Object.defineProperty(e,i,o),o};let L=class extends O{constructor(){super(),this.unsubscribe=[],this.checked=W.state.isLegalCheckboxChecked,this.unsubscribe.push(W.subscribeKey("isLegalCheckboxChecked",e=>{this.checked=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){const{termsConditionsUrl:e,privacyPolicyUrl:i}=u.state,r=u.state.features?.legalCheckbox,n=!!(e||i)&&!!r&&!this.checked,a=n?-1:void 0;return c`
    ...
    `}};L.styles=V;T([l()],L.prototype,"checked",void 0);L=T([I("w3m-connect-socials-view")],L);const q=_`
  wui-logo {
    width: 80px;
    height: 80px;
