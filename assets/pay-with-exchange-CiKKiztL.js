import{d1 as y,d6 as b,cV as f,d7 as a,db as w,cR as p,cP as k,dc as A,dw as c,d5 as P,cQ as I}from"./index-DfHOpLT0.js";import{E as t}from"./ExchangeController-DmljW7P3.js";const v=y`
...
`;var u=function(i,e,n,o){var l=arguments.length,s=l<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,n):o,m;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")s=Reflect.decorate(i,e,n,o);else for(var d=i.length-1;d>=0;d--)(m=i[d])&&(s=(l<3?m(s):l>3?m(e,n,s):m(e,n))||s);return l>3&&s&&Object.defineProperty(e,n,s),s};const g=[10,50,100];let r=class extends b{constructor(){super(),this.unsubscribe=[],this.network=f.state.activeCaipNetwork,this.exchanges=t.state.exchanges,this.isLoading=t.state.isLoading,this.amount=t.state.amount,this.tokenAmount=t.state.tokenAmount,this.priceLoading=t.state.priceLoading,this.isPaymentInProgress=t.state.isPaymentInProgress,this.currentPayment=t.state.currentPayment,this.paymentId=t.state.paymentId,this.paymentAsset=t.state.paymentAsset,this.unsubscribe.push(f.subscribeKey("activeCaipNetwork",e=>{this.network=e,this.setDefaultPaymentAsset()}),t.subscribe(e=>{this.exchanges=e.exchanges,this.isLoading=e.isLoading,this.amount=e.amount,this.tokenAmount=e.tokenAmount,this.priceLoading=e.priceLoading,this.paymentId=e.paymentId,this.isPaymentInProgress=e.isPaymentInProgress,this.currentPayment=e.currentPayment,this.paymentAsset=e.paymentAsset,e.isPaymentInProgress&&e.currentPayment?.exchangeId&&e.currentPayment?.sessionId&&e.paymentId&&this.handlePaymentInProgress()}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e()),t.reset()}async firstUpdated(){await this.getPaymentAssets(),this.paymentAsset||await this.setDefaultPaymentAsset(),this.onPresetAmountClick(g[0]),await t.fetchExchanges()}render(){return a`
      ...
      <wui-flex flexDirection="column" gap="3" .padding=${["0","3","3","3"]} class="amount-input-container">
        ...
        <wui-flex flexDirection="column" alignItems="center" justifyContent="center">
          ...
          <wui-flex justifyContent="space-between" gap="2">
            ${g.map(e=>a`<wui-button @click=${()=>this.onPresetAmountClick(e)} variant=${this.amount===e?"neutral-primary":"neutral-secondary"} size="sm" fullWidth>$${e}</wui-button>`)}
          </wui-flex>
        </wui-flex>
      </wui-flex>
    ...
    `}async onExchangeClick(e){if(!this.amount){p.showError("Please enter an amount");return}await t.handlePayWithExchange(e.id)}handlePaymentInProgress(){const e=f.state.activeChain;this.isPaymentInProgress&&this.currentPayment?.exchangeId&&this.currentPayment?.sessionId&&this.paymentId&&(t.waitUntilComplete({exchangeId:this.currentPayment.exchangeId,sessionId:this.currentPayment.sessionId,paymentId:this.paymentId}).then(n=>{n.status==="SUCCESS"?(p.showSuccess("Deposit completed"),e&&(k.fetchTokenBalance(),A.updateBalance(e))):n.status==="FAILED"&&p.showError("Deposit failed")}),p.showLoading("Deposit in progress..."),w.replace("Account"))}onPresetAmountClick(e){t.setAmount(e)}async getPaymentAssets(){this.network&&await t.getAssetsForNetwork(this.network.caipNetworkId)}async setDefaultPaymentAsset(){if(this.network){const e=await t.getAssetsForNetwork(this.network.caipNetworkId);e[0]&&t.setPaymentAsset(e[0])}}};r.styles=v;u([c()],r.prototype,"network",void 0);u([c()],r.prototype,"exchanges",void 0);u([c()],r.prototype,"isLoading",void 0);u([c()],r.prototype,"amount",void 0);u([c()],r.prototype,"tokenAmount",void 0);u([c()],r.prototype,"priceLoading",void 0);u([c()],r.prototype,"isPaymentInProgress",void 0);u([c()],r.prototype,"currentPayment",void 0);u([c()],r.prototype,"paymentId",void 0);u([c()],r.prototype,"paymentAsset",void 0);r=u([P("w3m-deposit-from-exchange-view")],r);const $=y`
  .contentContainer {
    height: 440px;
    overflow: scroll;
...
`;var x=function(i,e,n,o){var l=arguments.length,s=l<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,n):o,m;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")s=Reflect.decorate(i,e,n,o);else for(var d=i.length-1;d>=0;d--)(m=i[d])&&(s=(l<3?m(s):l>3?m(e,n,s):m(e,n))||s);return l>3&&s&&Object.defineProperty(e,n,s),s};let h=class extends b{constructor(){super(),this.unsubscribe=[],this.assets=t.state.assets,this.search="",this.onDebouncedSearch=I.debounce(e=>{this.search=e}),this.unsubscribe.push(t.subscribe(e=>{this.assets=e.assets}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return a`
    ...
    `}onBuyClick(){w.push("OnRampProviders")}onInputChange(e){this.onDebouncedSearch(e.detail)}handleTokenClick(e){t.setPaymentAsset(e),w.goBack()}};h.styles=$;x([c()],h.prototype,"assets",void 0);x([c()],h.prototype,"search",void 0);h=x([P("w3m-deposit-from-exchange-select-asset-view")],h);export{h as W3mDepositFromExchangeSelectAssetView,r as W3mDepositFromExchangeView};
