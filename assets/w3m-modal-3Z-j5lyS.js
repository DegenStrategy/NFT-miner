import{dN as p,ei as I,db as l,dc as le,d1 as k,d2 as B,d5 as w,d6 as g,d7 as c,d4 as u,dv as T,dh as R,dw as d,d3 as ce,cV as h,ds as H,eg as de,dU as L,cO as F,cX as E,dj as K,cP as V,d8 as ue,cR as S,ej as O,ed as G,du as pe,dt as ee,ek as he,e8 as me,cQ as fe,dd as we}from"./index-DevoNqzU.js";import"./index-B4IjSyAQ.js";import{S as be}from"./SwapController-CwOQxFlC.js";const te={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){p.shake();return}if(await I.isSIWXCloseDisabled()){p.shake();return}(l.state.view==="DataCapture"||l.state.view==="DataCaptureOtpConfirm")&&le.disconnect(),p.close()}},ge=k`
  :host {
    display: block;
...
`;var M=function(e,t,o,r){var a=arguments.length,i=a<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,o):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,r);else for(var s=e.length-1;s>=0;s--)(n=e[s])&&(i=(a<3?n(i):a>3?n(t,o,i):n(t,o))||i);return a>3&&i&&Object.defineProperty(t,o,i),i};const xe={info:"info",success:"checkmark",warning:"warningCircle",error:"warning"};let P=class extends g{constructor(){super(...arguments),this.message="",this.type="info"}render(){return c`
    ...
    `}onClose(){R.close()}};P.styles=[B,ve];M([u()],P.prototype,"message",void 0);M([u()],P.prototype,"type",void 0);P=M([w("wui-alertbar")],P);const ke=k`
  :host {
    display: block;
    position: absolute;
    top: ${({spacing:e})=>e[3]};
