import{dN as p,ei as I,db as l,dc as le,d1 as k,d2 as B,d5 as w,d6 as g,d7 as c,d4 as u,dv as T,dh as R,dw as d,d3 as ce,cV as h,ds as H,eg as de,dU as L,cO as F,cX as E,dj as K,cP as V,d8 as ue,cR as S,ej as O,ed as G,du as pe,dt as ee,ek as he,e8 as me,cQ as fe,dd as we}from"./index-BSLBHwR3.js";import"./index-DNi9tPlb.js";import{S as be}from"./SwapController-CruDOxCA.js";const te={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){p.shake();return}if(await I.isSIWXCloseDisabled()){p.shake();return}(l.state.view==="DataCapture"||l.state.view==="DataCaptureOtpConfirm")&&le.disconnect(),p.close()}},ge=k`
  :host {
    display: block;
