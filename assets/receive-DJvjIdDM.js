import{d1 as k,d2 as $,d3 as C,d4 as x,d5 as y,d6 as v,d7 as c,cP as p,cV as d,cR as m,ds as h,dt as N,du as g,dv as R,de as A,df as I,db as S,cQ as T,dw as f}from"./index-Bsk-3PfJ.js";const O=k`
  button {
    width: 100%;
    display: flex;
    align-items: center;
...
`;var b=function(e,t,o,r){var s=arguments.length,i=s<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,o):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,r);else for(var a=e.length-1;a>=0;a--)(n=e[a])&&(i=(s<3?n(i):s>3?n(t,o,i):n(t,o))||i);return s>3&&i&&Object.defineProperty(t,o,i),i};let u=class extends v{constructor(){super(...arguments),this.networkImages=[""],this.text=""}render(){return c`
    ...
    </wui-flex>`}};u.styles=[$,C,O];b([x({type:Array})],u.prototype,"networkImages",void 0);b([x()],u.prototype,"text",void 0);u=b([y("wui-compatible-network")],u);const _=k`
...
`;var w=function(e,t,o,r){var s=arguments.length,i=s<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,o):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,r);else for(var a=e.length-1;a>=0;a--)(n=e[a])&&(i=(s<3?n(i):s>3?n(t,o,i):n(t,o))||i);return s>3&&i&&Object.defineProperty(t,o,i),i};let l=class extends v{constructor(){super(),this.unsubscribe=[],this.address=p.state.address,this.profileName=p.state.profileName,this.network=d.state.activeCaipNetwork,this.unsubscribe.push(p.subscribe(t=>{t.address?(this.address=t.address,this.profileName=t.profileName):m.showError("Account not found")}),d.subscribeKey("activeCaipNetwork",t=>{t?.id&&(this.network=t)}))}disconnectedCallback(){this.unsubscribe.forEach(t=>t())}render(){if(!this.address)throw new Error("w3m-wallet-receive-view: No account provided");const t=h.getNetworkImage(this.network);return c` <wui-flex
    ...
    </wui-flex>`}networkTemplate(){const t=d.getAllRequestedCaipNetworks(),o=d.checkIfSmartAccountEnabled(),r=d.state.activeCaipNetwork,s=t.filter(a=>a?.chainNamespace===r?.chainNamespace);if(A(r?.chainNamespace)===I.ACCOUNT_TYPES.SMART_ACCOUNT&&o)return r?c`<wui-compatible-network
